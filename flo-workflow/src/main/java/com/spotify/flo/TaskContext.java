 ...
 *
 * <p>An taskContext is an object that is aware of the lifecycle of a task and can perform
 * operations before and after the task evaluates. A common use case for taskContexts is to be able
...
public interface TaskContext<T> {
  ...
  /**
   * Creates a new taskContext instance of type {@link T}. The given {@link EvalContext} will be
   * the context which was used to evaluate the task which this taskContext is being injected into.
   ...
   * @return An instance of the provided taskContext type
   */
  T provide(EvalContext evalContext);

  /**
   * Will be called just before a task that is using this taskContext starts evaluating.
   *
  ...
  /**
   * Will be called just after a task that is using this taskContext has successfully evaluated.
   *
  ...
  /**
   * Will be called just after a task that is using this taskContext has failed evaluating.
   *
   * @param task      The task that evaluated
